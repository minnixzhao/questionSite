...
<div class="container">
    <form action="<%=basePath %>permission/addPermission" class="form-horizontal" method="post">
        <!--以下录入表单-->
        ...
        <div class="form-group">
            ...
            <input class="form-control" value="" id="permissionName" name="permissName" type="text"/>
        </div>
        <div class="form-group">
            <label for="permissionMenuName" class="contro-label">权限描述:</label>
            <input class="form-control" value="" id="permissionMenuName" name="permissDes" type="text"/>
        </div>
