...
<div class="container">
    <form action="<%=basePath %>role/updateRole" class="form-horizontal" method="post">
        <input type="hidden" name="roleId" value="${requestScope.role.roleId }">
        <input type="hidden" name="pId" value="0">
        <div class="form-group">
            <label for="roleName" class="contro-label">角色名称:</label>
            <input class="form-control" value="${requestScope.role.roleName }" id="roleName" name="roleName" type="text"/>
        </div>
        <div class="form-group">
            <label for="roleDes" class="contro-label">角色描述:</label>
            <input class="form-control" value="${requestScope.role.roleDes}" id="roleDes" name="roleDes" type="text"/>
        </div>
