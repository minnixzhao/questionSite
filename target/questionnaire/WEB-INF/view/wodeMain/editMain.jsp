			...
			<div class="modal-content">
				...
				<div class="modal-body" id="editModalBody">
					<form id="editAnswer" action="<%=basePath %>question/addQuestionAndAnswer" method="post"  >
						...
						<div class="form-group">
							<label>问题:</label>
							<input type="text" class="form-control" id="questionTitle1"name="questionTitle" />
						</div>
						<div class="form-group">
				...
				<div class="modal-footer">
					<button class="btn btn-default" data-dismiss="modal">关闭</button>
					<button class="btn btn-primary" type="button" onclick="return submitFormById('editAnswer')">确定</button>
				</div>
			</div>
		</div>
	</div>
